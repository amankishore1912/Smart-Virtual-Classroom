            ...
            >
                <div className='joinClass'>
                    <div className="joinClass__wrapper">
                        <div className="joinClass__wraper2" onClick={() => setJoinClassDialog(false)}>
                            <Close className='joinClass__svg' />

                            <div className="joinClass__topHead">Join Class</div>

                        </div>
                        <Button className='joinClass__btn' variant='contained' color='primary' onClick={handleSubmit}>
                            Join
                        </Button>
                    </div>
                    <div className="joinClass__form">
                        <p className='joinClass_formText'>
